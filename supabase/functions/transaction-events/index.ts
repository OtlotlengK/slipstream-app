...
serve(async(req)=>{
 ...
 return json({success:true,event:{id:event.id,receipt_id:event.receipt_id,event_type:event.event_type,created_at:event.created_at},protocol_version:"1.2"},201);
});